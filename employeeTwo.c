...
{
	return strcmp((char *) targetPtr, tableValuePtr -> name); // const void *targetPtr ==> typecast as double pointer then dereference
}
...
PtrToEmployee searchEmployeeByNumber(PtrToConstEmployee ptr, int size, char *phone)
{
